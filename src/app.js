      ...
      function buildResult(agg, config) {
        ...
        const claims = {
          ...
          ga4: {
            claimAllowed: !!(overall && !lastGa4Import.warning && hostReliability !== "limited" && pageviewReliability !== "limited" && !ga4DecisionBlocked),
            ...
            forbiddenConclusions: !(overall && !lastGa4Import.warning && hostReliability !== "limited" && pageviewReliability !== "limited" && !ga4DecisionBlocked)
