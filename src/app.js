      ...
      function buildResult(agg, config) {
        ...
        const evidence = {
          ...
          ga4: {
            type: overall && !lastGa4Import.warning && hostReliability !== "limited" ? "comparison" : "not_determinable",
            reliability: ga4Reliability,
            canAnswer: !!(overall && !lastGa4Import.warning && hostReliability !== "limited"),
            reason: lastGa4Import.warning || (!overall ? "Keine brauchbaren GA4-Seitenzahlen eingetragen." : (hostReliability === "limited" ? "Die Datei enthält mehrere Websites. Ohne Filter ist der GA4-Vergleich unsicher." : "GA4 wurde mit denselben Seitenadressen aus der Server-Datei verglichen."))
          },
          hostScope: {
        ...
        const claims = {
          ...
          ga4: {
            claimAllowed: !!(overall && !lastGa4Import.warning && hostReliability !== "limited" && pageviewReliability !== "limited"),
