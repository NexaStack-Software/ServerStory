...
run("node", ["--check", "scripts/download-access-fixtures.js"]);
...
run("node", ["--check", "tests/access-realworld.test.js"]);
run("node", ["--check", "tests/local-log-corpus.test.js"]);
run("npm", ["test"]);
run("npm", ["run", "test:benchmark"]);
run("npm", ["run", "test:realworld"]);
run("npm", ["run", "test:access-realworld"]);
run("npm", ["run", "test:local-logs"]);
